...
const config: DocsThemeConfig = {
  ...
  footer: {
    content: (
<footer className="mx-auto flex flex-col items-center text-center text-surface dark:text-white">
  <div className="container px-6 pt-6 items-center">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-2">
      <div className="mb-6">
        ...
        <ul className="mb-0 list-none">
          ...
          <li>
            <a href="#!">N8N Server Customization</a>
          </li>
          <li>
            <a href="#!">Art & NFT's</a>
          </li>
  ...
  <p className="w-full mt-6 text-xs text-center">
  {/* <a
          ...
          >
     Automated by Rapigent AI Agents
          </a> */}
